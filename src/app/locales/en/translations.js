    ...
    dataFilesListToolbar: {
      ...
      fileChunksModal: {
        ...
        providerRow: {
          ...
          invalidationStart: 'Invalidate duplicated data blocks on selected provider',
          ...
          disabledInProgress: 'Migration/replication/invalidaton unavailable as there are transfers in progress.',
          disabledInvalidationNoBlocks: 'Cannot schedule invalidation as there are no blocks that could be invalidated.',
